    ...
    <section className={classes.pagina}>
        ...
        <Collapse in={expanded} timeout="auto" unmountOnExit>
          <CardContent>
            <Typography paragraph>
              <h3>Cardápio Pizzas:</h3>
            </Typography>
            <Typography paragraph>
              <strong>Pizzas Gourmet e Especiais</strong>
            </Typography>
            <Typography paragraph>Pizza Gourmet - R$59,90</Typography>
            <Typography paragraph>Pizza Especial - R$ 45,00</Typography>
            <Typography>
      ...
      <Card className={classes.root}>
        ...
        <Collapse in={expanded} timeout="auto" unmountOnExit>
          <CardContent>
            <Typography paragraph>
              <h3>Cardápio Hamburguer:</h3>
            </Typography>
            <Typography paragraph>
              <strong>Hamburguer Artesanal e Tradicional</strong>
            </Typography>
            <Typography paragraph>Hamburguer Artesanal - R$29,90</Typography>
            <Typography paragraph>Hamburguer Tradional - R$ 19,90</Typography>
            <Typography>
              <strong>Faça seu pedido conosco!</strong>
            </Typography>
          </CardContent>
      ...
      <Card className={classes.root}>
        ...
        <Collapse in={expanded} timeout="auto" unmountOnExit>
          <CardContent>
            <Typography paragraph>
              <h3>Cardápio Batata:</h3>
            </Typography>
            <Typography paragraph>
              <strong>Batata Gourmet</strong>
            </Typography>
            <Typography paragraph>Batata com frango - R$29,90</Typography>
            <Typography paragraph>Batata com Bacon - R$ 29,90</Typography>
            <Typography>
              <strong>Faça seu pedido conosco!</strong>
            </Typography>
          </CardContent>
